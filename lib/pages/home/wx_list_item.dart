...
import 'package:flutter_wanandroid/bean/wx_article_bean.dart';
import 'package:flutter_wanandroid/widgets/browser.dart';

class WxArticleListPage extends StatefulWidget {
  int hostId;

  WxArticleListPage({Key key, this.hostId});

  @override
  WxArticleListState createState() => WxArticleListState(hostId);
}

class WxArticleListState extends State<WxArticleListPage>
  ...
  WxArticleListState(this.hostId);
  ...
  void _getArticles(int pageNum) async {
    Response response = await Dio()
        .get('https://wanandroid.com/wxarticle/list/$hostId/$pageNum/json');
    var articleBean = WxArticleBean.fromJson(json.decode(response.toString()));
    setState(() {
