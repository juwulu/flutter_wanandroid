...
class CategoryListPage extends StatefulWidget {
  ...
  CategoryListPage({Key key, this.id, this.title});

  @override
  CategoryListState createState() => CategoryListState(id, title);
}
...
class CategoryListState extends State<CategoryListPage>
  ...
  CategoryListState(this.id, this.title);
  ...
  void _getArticles(int pageNum) async {
    Response response = await Dio()
        .get('https://www.wanandroid.com/article/list/$pageNum/json?cid=$id');
